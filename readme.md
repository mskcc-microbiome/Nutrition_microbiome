...
This section maps the specific analysis scripts to the main figures and tables presented in the manuscript.

| Script | Output | Description |
| :--- | :--- | :--- |
| **072** | **Figure 1** | Generates the first main figure. |
| **173** | *Model Data* | Runs the Bayesian inference model and saves the output (required for Fig 2). |
| **176** | **Figure 2** | Visualizes the Bayesian model results using data generated by script `173`. |
| **R09** | **Figure 3** | Generates the third main figure. |
| **178** | **Figure 4** | Generates the fourth main figure. |

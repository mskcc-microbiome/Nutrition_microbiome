...
## effect size of the abx * sweets

```{r}
results <- read_csv('../data/R63_results_df_asv1.csv')
...
asv1_sweets <- results |>
  ...
  mutate(across(c(estimate, conf.low, conf.high),
                list(fold = ~ exp(.x)),
                .names = "{.col}_fold")) |>
  mutate(across(ends_with("_fold"), ~ round(.x, 2))) |>
  select(term, estimate, conf.low, conf.high,
         estimate_fold, conf.low_fold, conf.high_fold)

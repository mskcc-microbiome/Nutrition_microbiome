...
save_ggplot_data_to_excel(smoothie_longitudinal, processed_data, "../mouse_data.xlsx", "Sup_Figure_9b_smoothie", col_names = c(
  "plot_group" = "Treatement + Day",
  "cf_us_per_gram_stool" = "CFUs per gram stool",
  "treatment_group" = "Treatment",
  "trajectory_group" = "Treatment + Mouse Number"))
```

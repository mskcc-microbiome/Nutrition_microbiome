...
model_div <- brm( div_model,  
              ...
              seed = 123, sample_prior = T, file = '../data/173_div_model_interaction') 
...
fitPrior <- brm(div_model, data=meta, 
           ...
           sample_prior = "only", file = '../data/173_prior_only_model')
...
prior_pred 
ggsave('../data/173_Prior_pred_check.pdf')
```
...
fit <- brm(div_model, data=meta, 
                prior=div_priors, 
           sample_prior = "no", seed = 12, file = '../data/173_posterior_pred_check')
...
```{r}
S3 <- plot_grid(prior_pred, NA,post_pred,
...
ggsave('../data/S3_prior_and_post_pred_173.pdf',
...
ggsave('../data/173_Caterpillar Plot of Random Intercepts for Week.jpg', width = 6, height = 6)
```

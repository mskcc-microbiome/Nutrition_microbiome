...
f3_five_days
save_ggplot_data_to_excel(f3_five_days, plotdf, "../mouse_data.xlsx", "Sup_Figure_9a_21_day_exp", col_names = c(
  "xvar" = "Treatment + Day",
...
f3_sugars_days <- f3_sugars %>%    
  ...
  theme(axis.text =  element_text(size = 10),axis.title=element_text(size=10),legend.position = 'none',aspect.ratio=1/3)
f3_sugars_days
save_ggplot_data_to_excel(f3_sugars_days, plotdf, "../mouse_data.xlsx", "Sup_Figure_9c_alternate_sugars", col_names = c(
  "xvar" = "Treatment + Day",
  "cf_us_per_gram_stool" = "CFUs per gram stool",
  "grp" = "Treatment Group"))

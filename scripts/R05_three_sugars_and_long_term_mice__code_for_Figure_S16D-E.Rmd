...
f3_five %>%  
  select(abx_treatment__diet_treatment__day = xvar, cf_us_per_gram_stool ) |> 
  write_csv('../data/R05_21days_E9a.csv')
```
...
f3_sugars %>% select(abx_treatment__diet_treatment__day = xvar, cf_us_per_gram_stool) |> write_csv('../data/R05_threesugars_E9c.csv')

...
## 1F: time relative to transplant
...
# 1I: the macronutrients 3 by 2 grid
...
middle_maps <- plot_grid(out2_umap, out2_caloric, umap_faith, umap_drt_high_to_low_bin,
          nrow = 1, hjust = 0,
          align = 'hv',
          labels = c('C','D', 'E', "F"),
          axis = 'tblr')
...
# top row 
top_row <- plot_grid(two_hist, tree, 
          nrow = 1, 
         rel_widths = c(.8,1.5), 
          labels = c('A', 'B', NA))

bottom_row <- plot_grid(line_column,m_panel, fg_panel, 
          nrow = 1, 
          #align = 'h',
          labels = c(NA, 'I', 'J'),
          #axis = 'tblr',

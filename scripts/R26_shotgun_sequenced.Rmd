...
```{r}
already <- read_rds('../data/phyloseq_for_angel_7.3.25_nutrition_human.rds')
...
# Create the plot
abundance_boxplot <- ggplot(abundance_plot_data, aes(x = fct_reorder(label, prevalence, .desc = TRUE), y = Abundance + pseudocount, fill = Relevance)) +

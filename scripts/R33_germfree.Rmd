...
CFU
save_ggplot_data_to_excel(CFU, plot_data, "../mouse_data.xlsx", "Sup_Figure_9d_time_course_monocolonization", col_names = c(
  "mouse_identifier" = "Mouse Identifier",
  "CFUs_per_GramStool" = "CFUs per gram stool",
  "Time_h" = "Time post innoculation (hours)"))
...
auc_plot 
save_ggplot_data_to_excel(auc_plot , auc_results, "../mouse_data.xlsx", "Sup_Figure_9d_auc_boxplot", col_names = c(
  "auc_value" = "Enterococcus load (AUC)"))

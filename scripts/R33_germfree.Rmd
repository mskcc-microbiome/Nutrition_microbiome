...
CFU <- ggplot() +
  ...
  # ) +
      scale_x_continuous(
    breaks = c(0, 4, 8, 24, 48),
    labels = c("0", "4", "8", "24", "48")
  ) +
  # Use a clean theme and add informative titles and labels.
  theme_bw(base_size = 14) +
  labs(
...
ggsave('../data/R33_gf_full_course_with_median_REPEAT.jpg', width = 10, height = 7)
```

...
nofiber <- read_csv('../data/R07_no_fiber_experiment_data_CFU.csv') %>% 
  ...
  dplyr::select(experiment:treatment, CFUs_per_GramStool:diet_treatment) %>% 
...
nofiber_days
save_ggplot_data_to_excel(nofiber_days, plotdf, "../mouse_data.xlsx", "Sup_Figure_8l_no_fiber_chow_CFU", col_names = c(
  "xvar" = "Treatment + Day",
  "logcfu" = "log 10 (Enterococcal CFU/gram stool)",
  "grp" = "Treatment Group"))

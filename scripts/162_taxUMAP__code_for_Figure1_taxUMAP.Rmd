...
```{bash}
run_taxumap.py -t ../../intermediate_data/162_food_taxa.csv -m ../../intermediate_data/162_food_code_relative.csv --agg_levels Kingdom/Phylum/Class/Order -n 173 --weights 0.01/2/10/10  
```

...
posterior_draws_df <- read_csv('../data/172_div_fg_posterior_draws.csv')
```
...
ggsave('../data/E01de_R53_randomintercept_and_sweets.pdf',
      width = 8.5, height = 19, units = "in", device = 'pdf', 
      dpi = 300)  
```

```{r}
# nor colored by the sweets intake
forest_plot_no_color <- ggplot(combined_data, 
       # Aesthetics:
       aes(
         # x-axis is the intercept value
         x = median_intercept, 
...
forest_plot_no_color

ggsave('../data/E01c_R53_patients_randomintercept.pdf',
      width = 8.5, height = 9, units = "in", device = 'pdf', 
      dpi = 300)  
```

...
# write out the data that produced this figure
prepared_data |> 
  select(experiment_no, mouse_identifier, day, treatment,cf_us_per_gram_stool  ) |> 
  write_csv('../data/R31_E8k.csv')
...
# output this table for reproducibility
df_plot_ready |> select(treatment_group, day, percent_change, mice_weights, experiment_no, mouse_identifier) |> 
  write_csv('../data/R31_mouse_weights_all.csv')

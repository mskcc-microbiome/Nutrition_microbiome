...
top_two <- plot_grid(
  top_row,
  longitudinal_plot,
  labels = c('', 'C'), # Add label for the bottom plot
  ncol = 1 # Arrange them in a single column
)

bottom_row <- plot_grid(log_diff_plot_31, log_diff_plot, labels = c('D', 'E'), ncol = 2, rel_widths = c(1.4,1))

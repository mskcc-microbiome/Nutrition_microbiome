...
save_ggplot_data_to_excel(chow_days, chow, "../mouse_data.xlsx", "Sup_Figure_8g_chow_consumed_days_3_6_9", col_names = c(
  "chow_per_day" = "Chow consumed (g/mouse/day)",
...
chow_AUC_plot
save_ggplot_data_to_excel(chow_AUC_plot, chow_AUC_wide, "../mouse_data.xlsx", "Sup_Figure_8h_chow_consumed_auc", col_names = c(
  "trap" = "Trapezoidal AUC (grams of Chow Consumed)",

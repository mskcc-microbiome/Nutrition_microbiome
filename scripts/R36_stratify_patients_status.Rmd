...
p1 <- plot_data_1 |>
  ggplot(aes(x = fdrt, y = daily_sweets, color = intensity)) +
   geom_point(alpha = 0.2) +
    ...
    scale_y_sqrt() +
  labs(
    title = "Daily Sweets Intake vs. Day Relative to Transplant",
...
ggsave("../data/R36_sugar__and_sweets_intake_scatter_R.pdf", plot = final_plot, width = 7, height = 7, dpi = 300)
```

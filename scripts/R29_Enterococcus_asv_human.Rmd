...
e_asv <- read_csv('../data/R25_all_enterococcus_asv_in_sample.csv') %>% inner_join(meta %>% select(pid, sampleid, sdrt))
# asv_1 is feacium
e_asv |> write_csv('../data/R29_all_enterococcus_asv_in_sample_and_pid.csv')
```
...
clr_res %>% write_csv('../data/R29_all_ASV_CLR_counts.csv')
```
